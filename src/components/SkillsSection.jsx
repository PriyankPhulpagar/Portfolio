        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {categories.map((category, key) => (
            <button
              ...
              className={cn(
                "px-5 py-2 rounded-full transition-colors duration-300 capitalize focus:outline-none focus:ring-2 focus:ring-primary",
          ...
          {filteredSkills.map((skill, key) => (
            ...
            >
              ...
              <div className="w-full bg-secondary/50 h-2 rounded-full overflow-hidden">
                <div
                  className={cn(
                    "h-2 rounded-full origin-left animate-[grow-_1.5s_ease-out]",
